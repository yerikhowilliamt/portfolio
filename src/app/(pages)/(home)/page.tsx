...
export default function Home() {
  return (
    <Main>
      <div className='flex w-full h-full justify-center xl:pr-20 2xl:pr-24'>
        {/* Text */}
        <div className='relative flex w-full h-full'>
          <div className='w-full static xl:absolute top-0 flex flex-col gap-8 text-center md:text-start'>
            ...
            >
              Hai 👋🏼👋🏼👋🏼... my name is Yerikho William Tasilima.
        ...
        <motion.div
          ...
          animate={{ y: 0, opacity: 1 }}
          transition={{ ease: 'easeInOut', duration: 1.75 }}
          className='relative lg:w-[520px] lg:h-[320px] xl:w-[320px] xl:h-[320px] lg:right-0 hidden lg:block'
        >
          <Avatar />
        </motion.div>
      </div>
